<template>
	...
	>
		<!-- Decorative circles -->
		<div
			class="absolute z-0 -top-20 -left-40 w-96 h-96 bg-[#06b6d4] rounded-full opacity-10 md:block hidden"
		></div>
		<div
			class="absolute z-0 -bottom-40 -right-20 w-[500px] h-[500px] bg-[#06b6d4] rounded-full opacity-10 md:block hidden"
		></div>
		...
		>
			...
			>
				<RouterLink
					to="/auth/login"
					class="w-full sm:w-auto inline-block px-8 py-3 rounded-md text-lg font-medium shadow-lg 
